...
- /integration-debugging — BEFORE investigating any integration sync issue, data import failure, or question about integration data. Covers the database tables, API log retrieval, S3 payload inspection, and provider code locations.
