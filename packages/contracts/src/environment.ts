...
export const ExecutionEnvironmentCapabilities = Schema.Struct({
  ...
  directTerminals: Schema.optionalKey(Schema.Boolean),
  workerTerminals: Schema.optionalKey(Schema.Boolean),
  workspaceReviewArtifacts: Schema.optionalKey(Schema.Boolean),
