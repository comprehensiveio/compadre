...
Web and desktop have no product-level attachment-count limit; mobile allows eight
files per message. Images can be up to 10 MB; other files can
...
Rewinding is unavailable in hosted Compadre. In local environments that support
it, choose **Edit from here** beneath a sent message to rewind
