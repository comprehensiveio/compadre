      ...
      return {
        ...
        moveComposerPromptAndImages: (from, to) => {
          ...
          set((state) => {
            ...
            const movedImages = source.images;
            ...
            const movedFiles = transferableFiles.map((file) => {
            ...
            const movedContextIds = new Set([
              ...movedImages.map((image) => toKindScopedComposerContextId("image", image.id)),
