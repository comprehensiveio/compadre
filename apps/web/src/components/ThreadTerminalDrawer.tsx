...
export function TerminalViewport({
  ...
  return (
    <div className="relative h-full w-full overflow-hidden bg-terminal">
      <div ref={containerRef} tabIndex={-1} className="h-full w-full" />
      {workerTerminal && terminalStatus === "error" && (
        <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 bg-terminal p-5 text-center text-sm">
