...
// v5 invalidates snapshots written before Compadre sender attribution was
// preserved by the live reducer. Those snapshots have a current event cursor
// but incomplete message metadata, so resuming them cannot repair the missing
// fields; a cold HTTP snapshot is required once. It also refreshes pre-reasoning roles.
