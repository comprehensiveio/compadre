...
export const make = Effect.gen(function* () {
  ...
  const descriptor: ExecutionEnvironmentDescriptor = {
    ...
    capabilities: {
      ...
      questionAttachments: !process.env.COMPADRE_NATIVE_T3_URL,
      ...
      storageCleanup: !process.env.COMPADRE_NATIVE_T3_URL,
      projectWorktreeCleanup: !process.env.COMPADRE_NATIVE_T3_URL,
      ...
      threadActiveReorder: !process.env.COMPADRE_NATIVE_T3_URL,
      threadAutoSettleOptOut: !process.env.COMPADRE_NATIVE_T3_URL,
      threadTitleRegeneration: true,
      threadPullRequests: true,
      pullRequestStackActions: !process.env.COMPADRE_NATIVE_T3_URL,
