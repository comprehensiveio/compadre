...
export interface ProjectionThreadMessageRepositoryShape {
   ...
   */
  /** Ordered actor metadata for rebuilding participation without reading message bodies. */
  readonly listUserAttributions: (
    input: ListProjectionThreadMessagesInput,
  ) => Effect.Effect<ReadonlyArray<MessageAttribution>, ProjectionRepositoryError>;
