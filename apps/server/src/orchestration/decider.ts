      ...
      const userMessageEvent: Omit<OrchestrationEvent, "sequence"> | null = persistedUserMessage
        ...
        : {
            ...
            payload: {
              ...
              ...(command.message.attribution !== undefined
                ? { attribution: command.message.attribution }
                : {}),
      ...
      const turnStartRequestedEvent: Omit<OrchestrationEvent, "sequence"> = {
        ...
        payload: {
          ...
          ...(command.message.providerPrompt !== undefined
            ? { providerPrompt: command.message.providerPrompt }
            : {}),
          ...(command.modelSelection !== undefined
            ? { modelSelection: command.modelSelection }
            : {}),
    ...
    case "thread.message.reasoning.complete": {
      ...
      return {
        ...
        payload: {
          ...
          text: "",
          ...("attachments" in command && command.attachments !== undefined
