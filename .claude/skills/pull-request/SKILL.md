...
- If the work originated from a **Slack thread**: append ` - initiated in [Slack](URL)` after `[Generated by Compadre]`
  ```
  [Generated by Compadre] - initiated in [Slack](https://comprehensiveio.slack.com/archives/CXXXXXX/pXXXXXXXXXX)
  ```
...
[Generated by Compadre] - initiated in [Slack](https://comprehensiveio.slack.com/archives/C.../p...)
