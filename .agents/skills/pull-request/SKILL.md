...
- If the work originated from a **Slack thread**: append ` - initiated in [slack thread](URL)` after `[Generated by Compadre]`
  ```
  [Generated by Compadre] - initiated in [slack thread](https://comprehensiveio.slack.com/archives/CXXXXXX/pXXXXXXXXXX)
  ```
...
[Generated by Compadre] - initiated in [slack thread](https://comprehensiveio.slack.com/archives/C.../p...)
